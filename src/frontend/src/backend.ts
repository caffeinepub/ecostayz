...
export class Backend implements backendInterface {
    ...
    async addProperty(arg0: string, arg1: string, arg2: string, arg3: string, arg4: Array<string>, arg5: bigint, arg6: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addProperty(arg0, arg1, arg2, arg3, arg4, arg5, arg6);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async getSeedProperties(): Promise<Array<Property>> {
        if (this.processError) {
            try {
                const result = await this.actor.getSeedProperties();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
